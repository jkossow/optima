...
public class Renta  extends DochodWydatek {

		public Renta() {
			super( DochodWydatekTyp.RENTA );
		}
		
		public Renta( BigDecimal kwotaNetto ) {
			super( kwotaNetto );
			setTyp( DochodWydatekTyp.RENTA );
		}
		
		public  Renta( String opis, BigDecimal kwotaBrutto, BigDecimal kwotaNetto, 
